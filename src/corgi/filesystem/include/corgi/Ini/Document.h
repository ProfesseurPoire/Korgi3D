...
namespace corgi::ini
{
    ...
    public:
         ...
         */
        [[nodiscard]] bool exist(const std::string& name, const std::string& section = "no_section")const;
         ...
         *
         * @brief name       key's name
         * @brief section    keys's section name
         *
         * @returns Returns nullptr if the key could not be founded
         */
        [[nodiscard]] const std::variant<float,int,std::string>& value(const std::string& name, const std::string& section = "no_section")const;

        [[nodiscard]] float& get_float(const std::string& name, const std::string& section = "no_section");
        [[nodiscard]] int& get_int(const std::string& name, const std::string& section = "no_section");
        [[nodiscard]] std::string& get_string(const std::string& name, const std::string& section = "no_section");
        ...
        void add(const std::string& name, const int& value, const std::string& section = "no_section");
        void add(const std::string& name, const float& value, const std::string& section = "no_section");
        void add(const std::string& name, const std::string& str, const std::string& section = "no_section");
    ...
    private:
        ...
        std::map<std::string, std::map<std::string, std::variant<float,int,std::string>>> values_;
    };
}
