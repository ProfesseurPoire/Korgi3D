...
namespace corgi
{
	...
	// Variables
		...
		// using unsigned short because I doubt I'll ever get a texture
		// that is > 64000
		unsigned short width_	= static_cast<unsigned short>(0);	// 2 bytes
		unsigned short height_	= static_cast<unsigned short>(0);	// 2 bytes
